...
func (m *InitiateRequest) GetSecret() string {
	if m != nil {
		return m.Secret
	}
	return ""
...
type InitiateResponse struct {
	...
	ContractP2Sh         string   `protobuf:"bytes,7,opt,name=contract_p2sh,json=contractP2sh,proto3" json:"contract_p2sh,omitempty"`
	ContractTx           string   `protobuf:"bytes,8,opt,name=contract_tx,json=contractTx,proto3" json:"contract_tx,omitempty"`
	ContractTxHash       string   `protobuf:"bytes,9,opt,name=contract_tx_hash,json=contractTxHash,proto3" json:"contract_tx_hash,omitempty"`
	Fee                  int64    `protobuf:"varint,10,opt,name=fee,proto3" json:"fee,omitempty"`
	Feerate              float32  `protobuf:"fixed32,11,opt,name=feerate,proto3" json:"feerate,omitempty"`
	Errorno              ERRNO    `protobuf:"varint,14,opt,name=errorno,proto3,enum=protobind.ERRNO" json:"errorno,omitempty"`
	Errstr               string   `protobuf:"bytes,15,opt,name=errstr,proto3" json:"errstr,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
var fileDescriptor_9afe1911bb3b5204 = []byte{
	...
	,
}
