...
type PingWalletRPCRequest struct {
	...
	Certs                string   `protobuf:"bytes,8,opt,name=certs,proto3" json:"certs,omitempty"`
...
type ParticipateRequest struct {
	...
	Rpcpass              string   `protobuf:"bytes,7,opt,name=rpcpass,proto3" json:"rpcpass,omitempty"`
	Certs                string   `protobuf:"bytes,8,opt,name=certs,proto3" json:"certs,omitempty"`
	Secrethash           string   `protobuf:"bytes,9,opt,name=secrethash,proto3" json:"secrethash,omitempty"`
	PartAddress          string   `protobuf:"bytes,10,opt,name=part_address,json=partAddress,proto3" json:"part_address,omitempty"`
...
var fileDescriptor_9afe1911bb3b5204 = []byte{
	...
	,
}
